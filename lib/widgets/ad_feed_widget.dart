...
import '../screens/buyer/my_wall_screen.dart';
...
class _AdFeedWidgetState extends State<AdFeedWidget> {
  ...
  IconData _mediaIcon(PostMediaType t) {
    switch (t) {
            ...
            child: Row(
              ...
              children: [
                CircleAvatar(
                  ...
                  child: Text(post.authorName.isNotEmpty ? post.authorName[0] : '?', style: const TextStyle(color: AppColors.primaryBlue, fontWeight: FontWeight.bold)),
                ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          Text(post.authorName, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: AppColors.textDark)),
                          const SizedBox(width: 6),
                          Icon(_mediaIcon(post.mediaType), size: 13, color: AppColors.textLight),
                          const SizedBox(width: 4),
                          Text('· ${post.timeLabel}', style: const TextStyle(fontSize: 11, color: AppColors.textLight)),
                        ],
                      ),
                      const SizedBox(height: 4),
                      Text(post.text, style: const TextStyle(fontSize: 13, color: AppColors.textDark), maxLines: 2, overflow: TextOverflow.ellipsis),
                    ],
                  ),
                ),
              ],
            ...
            child: Row(
              ...
              children: [
                CircleAvatar(
                  ...
                  child: Text(post.authorName.isNotEmpty ? post.authorName[0] : '?', style: const TextStyle(color: Colors.deepOrange, fontWeight: FontWeight.bold)),
                ),
                const SizedBox(width: 12),
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Row(
                        children: [
                          Expanded(child: Text(post.authorName, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 13, color: AppColors.textDark))),
                          const Icon(Icons.local_fire_department, color: Colors.deepOrange, size: 14),
                          const SizedBox(width: 2),
                          Text('${post.responsePoints}', style: const TextStyle(fontSize: 12, fontWeight: FontWeight.bold, color: Colors.deepOrange)),
                        ],
                      ),
                      const SizedBox(height: 4),
                      Text(post.text, style: const TextStyle(fontSize: 13, color: AppColors.textDark), maxLines: 2, overflow: TextOverflow.ellipsis),
                      ...
                      Row(
                        children: [
                          ...
                          Text('${post.likes}', style: const TextStyle(fontSize: 11, color: AppColors.textLight)),
                          const SizedBox(width: 10),
                          const Icon(Icons.chat_bubble_outline, size: 12, color: AppColors.textLight),
                          const SizedBox(width: 3),
                          Text('${post.comments}', style: const TextStyle(fontSize: 11, color: AppColors.textLight)),
                          const SizedBox(width: 10),
                          const Icon(Icons.share_outlined, size: 12, color: AppColors.textLight),
                          const SizedBox(width: 3),
                          Text('${post.shares}', style: const TextStyle(fontSize: 11, color: AppColors.textLight)),
                        ],
                      ),
                    ],
                  ),
